"""add type_code to shopping_suppliers and brand_id to shopping_products
...
def upgrade() -> None:
    ...
    # 3. Aggiunge colonna brand_id a shopping_products con Foreign Key verso shopping_suppliers.id
