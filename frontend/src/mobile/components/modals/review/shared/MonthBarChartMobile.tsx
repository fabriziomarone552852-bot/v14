// src/mobile/components/modals/review/shared/MonthBarChartMobile.tsx
import React from 'react';
import { MESI_BREVI } from '../yearReview.utils';

export interface MonthBarChartMobileProps {
  data: Record<number, number>;
}

/** Grafico a barre Mesi a tutta larghezza per Mobile */
export const MonthBarChartMobile: React.FC<MonthBarChartMobileProps> = ({ data }) => {
