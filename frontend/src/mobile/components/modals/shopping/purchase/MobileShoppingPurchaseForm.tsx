// src/mobile/components/modals/shopping/purchase/MobileShoppingPurchaseForm.tsx
...
export interface MobileShoppingPurchaseFormProps {
...
export const MobileShoppingPurchaseForm: React.FC<MobileShoppingPurchaseFormProps> = ({
  itemTotalQuantity,
  unitCodeName,
  purchaseForm,
  setPurchaseForm,
