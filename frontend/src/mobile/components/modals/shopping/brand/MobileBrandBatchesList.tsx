// src/mobile/components/modals/shopping/brand/MobileBrandBatchesList.tsx
...
export interface MobileBrandBatchesListProps {
  batches: ItemBatchRecord[];
}

export const MobileBrandBatchesList: React.FC<MobileBrandBatchesListProps> = ({
  batches,
}) => {
  return (
    <div>
