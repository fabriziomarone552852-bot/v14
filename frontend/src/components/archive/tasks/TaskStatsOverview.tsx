...
export const TaskStatsOverview: React.FC<TaskStatsOverviewProps> = ({
  ...
  const extraStats = (
    <>
      <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-50 border border-slate-200/80 text-xs">
        <span className="font-semibold text-slate-500">Totali:</span>
        <span className="font-extrabold text-slate-900">{stats.total}</span>
      </div>

      <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-50/70 border border-blue-200/80 text-xs">
        <span className="font-semibold text-blue-600">Da fare:</span>
        <span className="font-extrabold text-blue-700">{stats.active}</span>
      </div>

      <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-50/70 border border-emerald-200/80 text-xs">
      ...
      {stats.overdue > 0 && (
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-rose-50/70 border border-rose-200/80 text-xs">
