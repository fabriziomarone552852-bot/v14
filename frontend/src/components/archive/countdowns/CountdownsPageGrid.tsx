// src/components/archive/countdowns/CountdownsPageGrid.tsx
...
interface CountdownsPageGridProps {
  loading: boolean;
  isError: boolean;
  totalCount: number;
  ...
  onSelectCountdown: (countdown: CountdownItem) => void;
...
export const CountdownsPageGrid: React.FC<CountdownsPageGridProps> = ({
  loading,
  isError,
  totalCount,
  hasActiveFilters,
