...
interface ShoppingPurchasedItemEditModalProps {
  open: boolean;
  onClose: () => void;
...
export const ShoppingPurchasedItemEditModal: React.FC<ShoppingPurchasedItemEditModalProps> = ({
  ...
  return (
    <BaseModal
      ...
      formId="desktop-purchased-item-edit-form"
    ...
    >
      <form
        id="desktop-purchased-item-edit-form"
        onSubmit={handleSubmit}
        className="space-y-4"
      >
        {/* SEZIONE 1: DATI PRODOTTO */}
        <div className="bg-gray-50/70 rounded-2xl border border-gray-200 p-4 space-y-3">
          <h3 className="text-xs font-bold text-gray-700 uppercase tracking-wide border-b border-gray-200/80 pb-2">
        ...
        <div className="bg-emerald-50/40 rounded-2xl border border-emerald-200/80 p-4 space-y-3">
          ...
          {/* Data d'Acquisto & Toggle In Offerta */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 items-center pt-1">
            ...
            <div className="pt-5">
              <label className="flex items-center gap-2.5 p-2.5 bg-white border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
                <input
                  type="checkbox"
