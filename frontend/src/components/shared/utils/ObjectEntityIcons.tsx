...
export const FreeTimeIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const LocationIcon = ({ className = "h-5 w-5 text-gray-400" }: { className?: string }) => (
...
export const TaskListIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
  </svg>
)

export const UniversityIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const QuillIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
...
export const ScrollIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
// Icona Casella Vuota (Riquadro vuoto)
export const CheckboxEmptyIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <rect x="3" y="3" width="18" height="18" rx="4" stroke="currentColor" strokeWidth={2} />
  </svg>
);
...
// Icona Negozio / Fornitori (Storefront)
export const StoreIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 3h18v4a3 3 0 01-6 0 3 3 0 01-6 0 3 3 0 01-6 0V3z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 10v10a1 1 0 001 1h14a1 1 0 001-1V10M9 21v-6h6v6" />
  </svg>
);

// Icona Lucchetto (Privata)
...
// Icona Link Esterno / Apri Dettaglio
...
// Icona Trend Discendente / Prezzo Migliore
export const TrendDownIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6L9 12.75l4.286-4.286L21.75 16.5m0 0l-5.25.75m5.25-.75l-.75-5.25" />
  </svg>
);

// Icona Trend Ascendente
...
export const EyeHalfOpenIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h18" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12s4 5 9 5 9-5 9-5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 12a2.5 2.5 0 005 0" />
  </svg>
);

export const EyeClosedIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12s4 5 9 5 9-5 9-5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 17v2M8 15.5l-1.5 1.5M16 15.5l1.5 1.5" />
  </svg>
);
