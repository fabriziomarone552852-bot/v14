        ...
        >
          ...
          <div className="px-6 py-3.5 bg-slate-50 border-t border-slate-200/80 flex flex-col sm:flex-row items-center justify-between gap-2.5 shrink-0">
            ...
            <button
              ...
              className="inline-flex items-center justify-center px-4 py-2 rounded-xl bg-rose-50 hover:bg-rose-100 active:bg-rose-200/80 border border-rose-200 hover:border-rose-300 text-rose-700 font-bold text-xs transition-all shadow-2xs cursor-pointer active:scale-95"
            >
              Segnala un problema o suggerimento
            </button>
          </div>
        </div>
      </div>

      {/* Modale Feedback collegata */}
      <FeedbackModal
